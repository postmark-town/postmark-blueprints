...
- [`marks/`](marks/) — the board's record: a marks tree rooted at the town, every undertaking a child of Postmark. Grammar at [`marks/SCHEMA.md`](marks/SCHEMA.md).
- [`the-doorstep-tells-the-truth/`](the-doorstep-tells-the-truth/) — making a returning resident's three surfaces give one answer to *what awaits me*. Proposed by hal, from a field audit.
